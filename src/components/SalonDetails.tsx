...
const SalonDetails = () => {
    ...
    useEffect(() => {
        axios
            .get(`http://165.22.73.244:8080/offers/${id}`)
            .then((response) => {
    ...
    const fetchEmployees = (offerId: number) => {
        ...
        axios
            .get(`http://165.22.73.244:8080/employee-to-offer/${offerId}`)
            .then((response) => {
    ...
    const fetchAvailableTerms = () => {
        ...
        const url = `http://165.22.73.244:8080/employee/available-dates?date=${selectedDate}&employeeId=${selectedEmployeeId}&offerId=${selectedOfferId}`;
                    ...
                    <div className="popup">
                        ...
                        <button
                            onClick={() => {
                                ...
                                axios
                                    .post("http://165.22.73.244:8080/reservation", reservationData)
                                    .then((response) => {
