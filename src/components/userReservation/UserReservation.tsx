...
import { getUserReservations, deleteReservation, updateReservation } from '../../Services/reservationService';
        ...
        <div className="user-reservations">
                ...
                <ul className="reservations-list">
                    {reservations.map((reservation) => (
                        <li key={reservation.reservationId}>
                            ...
                            <p><strong>Date and Time:</strong> {new Date(reservation.reservationDateTime).toLocaleString()}</p>
            ...
            {selectedReservation && (
                <div className="selected-reservation">
                    ...
                    <p><strong>Date and Time:</strong> {new Date(selectedReservation.reservationDateTime).toLocaleString()}</p>
                    <button className="change-button" onClick={handleUpdateReservation}>Change</button>
                    <button className="cancel-button" onClick={() => handleDeleteReservation(selectedReservation.reservationId)}>Cancel</button>
                </div>
            )}
        </div>
    );
